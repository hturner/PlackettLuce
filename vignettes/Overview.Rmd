...
parameter is alo shown on the log scale here, but since it is an integral part 
...
an adjace`ncy matrix where element $(i, j)$ is the number of times item $i$ is 
...
```{r always-loses, fig.cap = "Network representation of toy rankings."}
library(igraph)
