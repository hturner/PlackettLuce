...
(ref:timings) Timings in seconds for fitting the Plackett-Luce model to data sets summarised in
Table \@ref(tab:data-features) using different packages. See Appendix [5.1](#app:timings) for details and code.
