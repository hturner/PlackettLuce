...
some preparation to collate the rankings, which is detailed in the example of
the help file of the `beans` dataset. Specifically, the code in the example will
results in a `rankings` object `R` which provides all rankings of the three
experimental varieties and the output of their comparison with the local
variety.
```{r beans-preparation, results = FALSE}
