...
output: function(...){
    if (requireNamespace('bookdown', quietly = TRUE)) {
        bookdown::html_document2(..., math_method = "mathml") }
...
[@Critchlow1991] that is provided as the `salad` data set in **PlackettLuce**. 
...
judges that ranked the four salads, based on their ranking of salad C
...
they rank salad C, so we expect the item worth to depend on this variable.
